...
For completeness, I have to mention the **IPCC AR6**, although it's a daunting read (whereas I've tried to curate more accessible resources below).
The abridged [synthesis report](https://www.ipcc.ch/report/ar6/syr/) is a good place to start.
...
**Ryan Orbuch** of [Lowercarbon Capital](https://lowercarboncapital.com/) put together a primer on CDR, [We need to take CO2 out of the sky](https://www.orbuch.com/carbon-removal/).
He also shared his [negative emissions reading list](https://www.orbuch.com/nets-reading-list/), which has substantial overlap with the one you're reading right now.

**Nan Ransohoff** heads [Stripe Climate](https://stripe.com/climate), which facilitates carbon removal purchases via an [advance market commitment](https://en.wikipedia.org/wiki/Advance_market_commitment) called Frontier.
She occasionally [writes](https://nanransohoff.substack.com/) about the economics of carbon removal.
...
**Homeworld Collective** maintains a [repository](https://www.homeworld.bio/research/problem-statement-repository/) of research problem statements linking biotechnology and climate.
- In early 2025, they're opening a [call for proposals](https://www.homeworld.bio/grants-greenhouse-gas-removal/) for biotech-driven CDR projects; if you have a project idea, you should apply! (Full disclosure: I'm one of their technical reviewers.) 

**Michael Nielsen** needs no introduction.
Unsurprisingly, despite not really working on climate, he's shared thoughtful "working notes" on [direct air capture](https://cognitivemedium.com/dac-notes).
- There are few decisions one can make in life that are as universally beneficial as [following him](https://twitter.com/michael_nielsen) on Twitter.

**Y Combinator** has a [request for startups](http://carbon.ycombinator.com/) working on carbon removal tech that includes a brief overview geared towards non-technical audiences.

**Erika Reinhardt** has a stunning [Data-Driven Guide to Effective Personal Climate Action](https://erikareinhardt.com/personal-climate-action).